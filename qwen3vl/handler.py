...
class Qwen3VLHandler(BaseHandler):
    def __init__(self):
        super(Qwen3VLHandler, self).__init__()
    ...
    def initialize(self, ctx):
        ...
        self.model = Qwen3VLForConditionalGeneration.from_pretrained("Qwen/Qwen3-VL-2B-Instruct", dtype="auto", quantization_config=self.bnb_config, device_map="auto")
