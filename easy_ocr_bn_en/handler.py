...
class EasyOCRHandler(BaseHandler):
    ...
    def _inference_english(self, img, bboxes):
        ...
        Uses temporary file strategy with readtext() for maximum accuracy.
        """
        output = []
        ...
        for bbox_idx, bbox in enumerate(bboxes):
            ...
            try:
                ...
                if x2 <= x1 or y2 <= y1:
                    print(f"⚠️ Bbox {bbox_idx} invalid dimensions, skipping.")
                ...
                # Use recognize() with horizontal_list for consistent accuracy
                print(f"🔍 Bbox {bbox_idx}: Starting recognize() for en language...")
                ...
                if ocr_results:
                    ...
                    print(f"⚠️ Bbox {bbox_idx}: No text detected")
                    output.append({"text": "", "confidence": 0.0})
