...
# EasyOCR required model files
DETECTION_MODEL="craft_mlt_25k.pth"
ENGLISH_MODEL="english_g2.pth"

# Construct the --extra-files argument
# Include: dependencies, opt.txt, CRAFT detector, and English recognizer
if [ ! -z "$4" ]; then
    EXTRA_FILES="./dependencies,models/opt.txt,/models/${DETECTION_MODEL},/models/${ENGLISH_MODEL},$4"
else 
    EXTRA_FILES="./dependencies,models/opt.txt,/models/${DETECTION_MODEL},/models/${ENGLISH_MODEL}"
fi
...
# --- Setup Directories ---
BASE_DIR="/mnt/data/projects/model_serve/easy_ocr_bn_en"
