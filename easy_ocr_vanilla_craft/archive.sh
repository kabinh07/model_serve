...
NAME=easy_ocr_vanilla_craft_en_bn
...
EXTRA_FILES_ARG="/models/${DETECTION_MODEL},/models/${LANG_EN},/models/${LANG_BN}"
...
BASE_DIR="/mnt/data/projects/model_serve/easy_ocr_vanilla_craft"
